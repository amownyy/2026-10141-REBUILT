...
import static frc.robot.Constants.AutoConstants.LAUNCH_SECONDS;
...
public class AutoLaunchSequence extends SequentialCommandGroup {
    ...
    public AutoLaunchSequence(FuelSubsystem fuelSubsystem) {
        // Add your commands in the addCommands() call, e.g.
        // addCommands(new FooCommand(), new BarCommand());
        addCommands(
                new SpinUp(fuelSubsystem).withTimeout(SPIN_UP_SECONDS),
                new LaunchTimed(fuelSubsystem, LAUNCH_SECONDS)
        );
    }
}